...
def main(_):
  ...
  total_jobs = training_system_metrics_df.groupby(
      ['domain', 'task', 'algo', 'seed', 'experiment']).run_id.nunique()
  ...
  total_cpus_on_collect_machine = 128  # https://cloud.google.com/compute/docs/general-purpose-machines#n2_series
  total_cpus_on_train_machine = 48  # https://cloud.google.com/compute/docs/gpus#a100-gpus
  true_collect_cpu_tdp = 300  # https://www.cpu-world.com/CPUs/Xeon/Intel-Xeon%208373C.html
  true_train_cpu_tdp = 165  # https://www.cpu-world.com/CPUs/Xeon/Intel-Xeon%208273CL.html
  training_system_metrics_df = correct_energy_measurements(training_system_metrics_df,
  ...
  training_metrics['generalization_rollout_returns'] = \
    generalization_reward_metrics[
