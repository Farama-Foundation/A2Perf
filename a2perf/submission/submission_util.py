...
def train(module_path, gin_config_str=None, absl_flags=None):
...
class Submission:
    ...
    def _perform_rollouts(
            self, num_episodes, measure_emissions, output_dir,
        ...
        create_domain_fn = functools.partial(
                suite_gym.create_domain, env_name=self.domain.value,
    ...
    def _run_generalization_benchmark(self):
        ...
        with open(
                os.path.join(self.metric_values_dir,
                             "generalization_rollouts.json"), "w"
        ) as f:
            ...
            if self.time_inference_steps:
                ...
                for i in range(self.num_inference_steps):
                    ...
                    inference_times.append(
                            timeit.timeit(inference_step, number=1))
    ...
    def run_benchmark(self):
        ...
        self.absl_flags = {name: flags.FLAGS[name].value for name in
                           flags.FLAGS}
