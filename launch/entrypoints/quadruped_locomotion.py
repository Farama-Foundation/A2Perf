...
_ENV_BATCH_SIZE = flags.DEFINE_integer('env_batch_size', None,
                                       'Number of environments to run in parallel.')
_NUM_EPOCHS = flags.DEFINE_integer('num_epochs', None, 'Number of epochs.')
_TOTAL_ENV_STEPS = flags.DEFINE_integer('total_env_steps', None,
...
_BATCH_SIZE = flags.DEFINE_integer('batch_size', None,
                                   'Batch size for training.')
_ROOT_DIR = flags.DEFINE_string('root_dir', None, 'Root directory.')
_PARTICIPANT_MODULE_PATH = flags.DEFINE_string('participant_module_path', None,
                                               'Participant module path.')
_RUN_OFFLINE_METRICS_ONLY = flags.DEFINE_boolean('run_offline_metrics_only',
                                                 None,
                                                 'Run offline metrics only.')
_TIMESTEPS_PER_ACTORBATCH = flags.DEFINE_integer('timesteps_per_actorbatch',
                                                 None,
                                                 'Timesteps per actor batch.')
_TRAIN_CHECKPOINT_INTERVAL = flags.DEFINE_integer('train_checkpoint_interval',
                                                  None,
                                                  'Train checkpoint interval.')
_POLICY_CHECKPOINT_INTERVAL = flags.DEFINE_integer('policy_checkpoint_interval',
                                                   None,
...
def main(_):
  ...
  os.environ['TIMESTEPS_PER_ACTOR_BATCH'] = str(
      _TIMESTEPS_PER_ACTORBATCH.value)
  ...
  os.environ['TIMESTEPS_PER_ACTORBATCH'] = str(
      _TIMESTEPS_PER_ACTORBATCH.value)
  command = (
