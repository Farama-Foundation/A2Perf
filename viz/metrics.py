...
get_ipython().system('pip install tensorboard sns tbparse matplotlib pandas scipy seaborn tensorflow')
...
base_dir = '/usr/local/google/home/ikechukwuu/workspace/a2perf/logs'
experiment_ids = [94408569]
...
# Also add any CSV files we find in the log dirs
len(event_log_dirs), len(emission_log_dirs)
